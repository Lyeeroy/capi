...
export class VideoProgressService {
  ...
  private updateUrlForAdvancedEpisode(): void {
    const queryParams = { ...this.route.snapshot.queryParams, episode: this.currentEpisode };
   ...
   */
  checkForEpisodeAdvancement(): { hasAdvanced: boolean; newSeason?: number; newEpisode?: number } {
